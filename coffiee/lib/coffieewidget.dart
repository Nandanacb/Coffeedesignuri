...
import 'package:coffiee/discription.dart';
                      ...
                      children: [
                        GestureDetector(
                          onTap: (){
                            ...
                            imagePath: DataBase.coffeeList[index]["image"],
                            name: DataBase.coffeeList[index]["name"],
                            price: DataBase.coffeeList[index]["price"],) ));
                          },
                          child: Container(
                            height: 100,
                            width: double.infinity,
